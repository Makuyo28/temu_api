...
<head>
    ...
    <title>Password Reset - TEMU</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Your password for the TEMU Traffic Enforcement System has been reset.</p>
            ...
            <div class="warning">
                ⚠️ If you did not request this password reset, please contact the TEMU administrator immediately.
            </div>
        </div>
